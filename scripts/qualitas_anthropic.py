"""
Qualitas Insurance Quote Automation - Anthropic Claude Version
Four-phase automation using Claude models
"""
...
async def main():
    """
    Four-phase automation for Qualitas insurance quote using Claude models
    """
    print("🚀 Starting Qualitas Insurance Automation - Anthropic Claude (4-Phase)")
    print("=" * 60)
